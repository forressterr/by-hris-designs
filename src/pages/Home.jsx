    ...
    <>
      ...
      <section className="landing">
        <div className="landing__text">
          ...
          <h1
            ref={titleRef}
            className="brand-hero__title landing__title"
          >
      ...
      */}
        ...
        <div className="tile-pair">
          ...
          >
            <SlideShow
              ...
              slides={[
                { src: '/home/home-1.jpg', alt: 'Hristian Goretsov — portrait' },
                { src: '/home/home-2.jpg', alt: 'Photo by Hristian Goretsov' },
                { src: '/home/home-3.jpg', alt: 'Photo by Hristian Goretsov' },
              ]}
            />
          </Parallax>
          <Parallax
      ...
      <Reveal as="section" className="section">
        ...
        <Reveal as="div" className="stats" stagger={0.06} style={{ marginTop: 56 }}>
          {labsStats.map((stat) => (
